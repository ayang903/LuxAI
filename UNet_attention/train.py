...
EPISODE_DIR = (
    "/projectnb/ds598xz/students/ayang903/final/sp2024_RL/full_episodes/top_agents"
)
MODEL_DIR = "/projectnb/ds598xz/students/ayang903/final/sp2024_RL/models/UNet_Attention"
...
def to_label(action, obs):
    ...
    unit_id = strs[1]
    if strs[0] == "m":
        label = {"n": 0, "s": 1, "w": 2, "e": 3, "c": None}[strs[2]] #maybe change c to 5
    elif strs[0] == "bcity":
        label = 4
    else:
        label = None
...
def create_dataset_from_json(episode_dir, team_name="Toad Brigade"):
    ...
    for filepath in tqdm(episodes):
        ...
        if json_load["info"]["TeamNames"][index] != team_name and json_load["info"]["TeamNames"][index] != "Team Q" and json_load["info"]["TeamNames"][index] != "Team GO":
            continue
